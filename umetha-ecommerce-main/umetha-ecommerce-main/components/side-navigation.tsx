...
const getCategories = (t: any): Category[] => [
  { 
    name: t('ecommerce.categories.fashion'),
    href: "/category/fashion",
    icon: Shirt,
    color: "from-indigo-500 to-violet-500",
  },
  {
    name: t('ecommerce.categories.beauty'),
    href: "/category/beauty",
    icon: Brush,
    color: "from-indigo-500 to-violet-500",
  },
  {
    name: t('ecommerce.categories.baby'),
    href: "/category/baby",
    icon: Baby,
    color: "from-indigo-500 to-violet-500",
  },
  {
    name: t('ecommerce.categories.home_decor'),
    href: "/category/decoration",
    icon: Home,
    color: "from-indigo-500 to-violet-500",
  },
  {
    name: t('ecommerce.categories.electronics'),
    href: "/category/electronics",
    icon: Cpu,
    color: "from-indigo-500 to-violet-500",
  },
  {
    name: t('ecommerce.categories.gaming'),
    href: "/category/gaming",
    icon: Gamepad2,
    color: "from-indigo-500 to-violet-500",
  },
  {
    name: t('ecommerce.categories.influencer_market'),
    href: "/category/influencerhub",
    icon: UserCircle,
    color: "from-indigo-500 to-blue-400",
  },
  {
    name: t('ecommerce.categories.bargains'),
    href: "/category/bargains",
    icon: Percent,
    color: "from-indigo-500 to-blue-400",
  },
  {
    name: t('ecommerce.categories.unique_finds'),
    href: "/category/unique",
    icon: Sparkles,
    color: "from-indigo-500 to-blue-400",
  },
  {
    name: t('ecommerce.categories.virtual_tryon'),
    href: "/virtual-tryon",
    icon: Camera,
