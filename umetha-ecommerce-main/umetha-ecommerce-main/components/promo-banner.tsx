...
const getSlides = (t: any) => [
  {
    ...
    alt: t('promo_banner.slide1.alt'),
    title: t('promo_banner.slide1.title'),
    href:"/category/fashion",
    subtitle: t('promo_banner.slide1.subtitle'),
    gradient: "from-blue-400 to-blue-600",
  },
  {
    src: "/gaming.png",
    alt: t('promo_banner.slide2.alt'),
    title: t('promo_banner.slide2.title'),
    href:"/category/gaming",
    subtitle: t('promo_banner.slide2.subtitle'),
    gradient: "from-blue-400 to-blue-600",
  },
  {
    src: "/UNIQUE.png",
    alt: t('promo_banner.slide3.alt'),
    title: t('promo_banner.slide3.title'),
    href:"/category/unique",
    subtitle: t('promo_banner.slide3.subtitle'),
    gradient: "from-blue-400 to-blue-600",
  },
  {
    src: "/fashion-slide2.png",
    alt: t('promo_banner.slide4.alt'),
    title: t('promo_banner.slide4.title'),
    href:"/category/fashion",
    subtitle: t('promo_banner.slide4.subtitle'),
    gradient: "from-blue-400 to-blue-600",
  },
  {
    src: "/electronics2.png",
    alt: t('promo_banner.slide5.alt'),
    title: t('promo_banner.slide5.title'),
    href:"/category/decoration",
    subtitle: t('promo_banner.slide5.subtitle'),
    gradient: "from-blue-400 to-blue-600",
  },
  {
    src: "/beauty-slider.png",
    alt: t('promo_banner.slide6.alt'),
    title: t('promo_banner.slide6.title'),
    href:"/category/beauty",
    subtitle: t('promo_banner.slide6.subtitle'),
    gradient: "from-blue-400 to-blue-600",
  },
];
